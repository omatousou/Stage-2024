...
range2 = 0+20:6:350; % Plage d'angles à parcourir pour le deuxième miroir
...
[x2LP, neff2LP, phase2LP, x2SP, neff2SP, phase2SP] = AnatoleCurveFit(angle2, X2(:, 1), max(X2(:, 1)), angle2(X2(:, 1) == max(X2(:, 1))), X2(:, 2), max(X2(:, 2)), angle2(X2(:, 2) == max(X2(:, 2))))
